...
/* 串行Flsh的片选GPIO端口  */
#define SF_CS_0()			(HAL_GPIO_WritePin(SPI_NSS_GPIO_Port, SPI_NSS_Pin, GPIO_PIN_RESET))
#define SF_CS_1()			(HAL_GPIO_WritePin(SPI_NSS_GPIO_Port, SPI_NSS_Pin, GPIO_PIN_SET))
...
{
	interface_module_spi_write_byte(_ucByte);
}
...
uint8_t bsp_spiRead1(void)
{
	...
	interface_module_spi_read_byte(&_ucByte);
...
{
	static uint32_t uiID;
	static uint8_t id1, id2, id3;
